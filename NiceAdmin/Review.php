...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item"><a class="nav-link " href="Review.php"><i class="bi bi-chat-dots"></i><span>Review</span></a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <!-- Session Messages -->
                            ...
                            <p class="text-center text-muted">Here is the list of all ReviewDetail. You can delete them as needed.</p>
...
$user = mysqli_query($conn, "
    SELECT reviews.review_id, reviews.message, reviews.rating AS review_rating, 
           products.name, users.first_name, users.last_name
    FROM reviews
...
if (mysqli_num_rows($user) > 0) {
    while ($row = mysqli_fetch_assoc($user)) {
        ...
        echo "<td>" . htmlspecialchars($row['review_rating'] ?? 'N/A') . "</td>";

        echo "<td>";
        // Delete button with confirmation
            echo "<a href='review.php?delete=" . urlencode($row['review_id']) . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure you want to delete this Review?')\">
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if (isset($_SESSION['delete_message']) && $_SESSION['delete_message'] == $review_id) {
        $_SESSION['error'] = "Review has already been deleted.";
    ...
    if ($delete_query) {
        $_SESSION['delete_message'] = $review_id;
