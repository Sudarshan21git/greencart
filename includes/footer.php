        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-about">
                    ...
                    <h3>GreenCart</h3>
                    <p>Bringing nature into your home since 2010. We're passionate about plants and dedicated to helping you create your own green sanctuary.</p>
                    <div class="social-icons">
                        ...
                        <a href="https://www.youtube.com/@sudarshansharma867" class="social-icon">
                ...
                <div class="footer-contact">
                    ...
                    <p><strong>Email:</strong> naturenursery@gmail.com</p>
                    <p><strong>Phone:</strong> +977 9882882488</p>
                </div>
                
                
            </div>
            <div class="footer-bottom">
                <p>&copy; <span id="current-year"></span> GreenCart. All rights reserved.</p>
            </div>
        </div>
    </footer>